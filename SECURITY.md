...
Security is very important for SageCoinAI and its community. This document outlines security procedures and general policies for this repository.
...
- Send this email to [security@coinsageai.click](mailto:security@coinsageai.click) and start the subject with your classification **Critical** or **Non-critical** followed by a short title of the bug.
